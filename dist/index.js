...
if (divContainer instanceof HTMLElement) {
    ...
    async function returnAPI(frase) {
        ...
        const response = await fetch(`https://api.funtranslations.com/translate/yoda.json?text=${encodeURIComponent(frase)}`);
